...
class Matey {
  ...
  /**
   * Fetch a remote data source, and use it to create a new data editor. Returns a promise of the loaded in value.
  ...
  /**
   * Fetch YARRRML rules from remote source and set YARRRML editor's value to them. Returns a promise of the loaded in rules.
