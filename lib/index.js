...
class Matey {
  ...
  /**
   * Fetch a remote data source, and use it to create a new data editor
  ...
  loadRemoteDataSource(url, dataPath) {
    // fetch content from remote source and create new data editor
    this.loadRemote(url, dataValue => {
