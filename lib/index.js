	  ...
	  console.log(data);
          ...
          try {
            ...
            if (typeof data.output === 'string' || data.output instanceof String) {
              ...
              parser.parse(data.output, (err, quad) => {
                if (quad) {
                  ...
                  outWriter.end(async (err, outTtl) => {
                    ...
                    this.front.setOutputButtonDivText('1 RDF output and RML rules');
              ...
              this.front.setOutputButtonDivText(`${Object.keys(data.output).length} RDF outputs and RML rules`);
              this.front.doAlert('Output updated!', 'success');
