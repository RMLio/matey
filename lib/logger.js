// I'm not using beaver-logger, in order to avoid interference with server logging done for the original Matey
// So here, I just export the console object as a logger
